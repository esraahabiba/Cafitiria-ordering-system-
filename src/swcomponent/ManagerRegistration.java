...
ManagerLogin malo = new ManagerLogin();
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
     ...
     manager1.setId(manager1.getId());
        manager1.setName(txtName.getText());
        manager1.setPhone(txtphone.getText());
        manager1.setMail(txtEmail.getText());
        manager1.setAddress(txtAddress.getText());
        manager1.setpassword(pfpassword.getText());
